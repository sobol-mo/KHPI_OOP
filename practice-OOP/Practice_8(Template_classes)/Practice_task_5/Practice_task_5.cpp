/*
    ...
    - деструктор;
    - перевантаження опрератора(+=), для додавання нового
    об'єкту;
    - перевантаження оператора кадратних дужок;
    - метод вилучаення покажчика з масиву;
    - гетер для розміру масиву. 

    Реалізовувати шаблоний клас в двох файлайлах:
    - заголовний файл;
    - файл реалізації.
