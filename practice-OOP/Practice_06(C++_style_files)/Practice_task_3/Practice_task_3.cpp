/*
	...
	- конструктор з параметрами, з параметрами
	за замовчуванням;
	- група "гетерів";
	...
	- функція додавання студента рейтингу;
	...
	останього студента у файл. Створити зручний інтерфейс для
...
int main()
{
	...
	while (true)
	{
		...
		cout << "3. Сортувати рейтинг (крітерій: оцінка з ООП)" << endl;
		...
		{
		case 1:
			cout << "Введіть (фамілію, оцінку з ООП/математики/філософії): ";
			cin >> student;
		...
		case 2:
			...
			if (deleteFlag) {
				cout << "Студент видален з рейтингу!" << endl;
			}
			else {
				cout << "Студент не знайден!" << endl;
			}
			break;
		case 3:
			rating.sortRating();
			cout << "Рейтинг відсортован!" << endl;
			break;
		case 4:
			rating.printRating();
			break;
